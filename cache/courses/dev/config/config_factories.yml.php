...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\inetpub\\skule_courses\\log/courses_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\inetpub\\skule_courses\\cache\\courses\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\inetpub\\skule_courses\\apps\\courses/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfNoCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\inetpub\\skule_courses\\cache\\courses\\dev\\config/routing',
  'lifetime' => 31556926,
  'prefix' => 'C:\\inetpub\\skule_courses\\apps\\courses/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\inetpub\\skule_courses\\cache\\courses\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\inetpub\\skule_courses\\apps\\courses/template',
)));
