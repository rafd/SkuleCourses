...
abstract class BaseCoursePeer {
	...
	const DESCR = 'course.DESCR';

	/** the column name for the DETAIL_ID field */
	const DETAIL_ID = 'course.DETAIL_ID';

	/** the column name for the IS_ENG field */
	const IS_ENG = 'course.IS_ENG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'DeptId', 'Descr', 'DetailId', 'IsEng', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'deptId', 'descr', 'detailId', 'isEng', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DEPT_ID, self::DESCR, self::DETAIL_ID, self::IS_ENG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'dept_id', 'descr', 'detail_id', 'is_eng', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DeptId' => 1, 'Descr' => 2, 'DetailId' => 3, 'IsEng' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'deptId' => 1, 'descr' => 2, 'detailId' => 3, 'isEng' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DEPT_ID => 1, self::DESCR => 2, self::DETAIL_ID => 3, self::IS_ENG => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'dept_id' => 1, 'descr' => 2, 'detail_id' => 3, 'is_eng' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CoursePeer::DESCR);

		$criteria->addSelectColumn(CoursePeer::DETAIL_ID);

		$criteria->addSelectColumn(CoursePeer::IS_ENG);
	...
	public static function doCountJoinDepartment(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CoursePeer::DEPT_ID,), array(DepartmentPeer::ID,), $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related CourseDetail table
	 *
	 * @param      Criteria $c
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinCourseDetail(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(array(CoursePeer::DETAIL_ID,), array(CourseDetailPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Course objects pre-filled with their Department objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
      ...
      call_user_func($callable, 'BaseCoursePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Course) to $obj2 (Department)
				$obj2->addCourse($obj1);
	...
	/**
	 * Selects a collection of Course objects pre-filled with their CourseDetail objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Course objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCourseDetail(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(CoursePeer::DETAIL_ID,), array(CourseDetailPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = CourseDetailPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = CourseDetailPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					CourseDetailPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (Course) to $obj2 (CourseDetail)
				$obj2->addCourse($obj1);
    ...
    foreach (sfMixer::getCallables('BaseCoursePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseCoursePeer', $c, $con);
		...
		CourseDetailPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + (CourseDetailPeer::NUM_COLUMNS - CourseDetailPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined CourseDetail rows

			$key3 = CourseDetailPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = CourseDetailPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					CourseDetailPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Course) to the collection in $obj3 (CourseDetail)
				$obj3->addCourse($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptCourseDetail(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Course objects pre-filled with all related objects except Department.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseCoursePeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseCoursePeer', $c, $con);
		...
		CourseDetailPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + (CourseDetailPeer::NUM_COLUMNS - CourseDetailPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = CoursePeer::getInstanceFromPool($key1))) {
				...
				$key2 = CourseDetailPeer::getPrimaryKeyHashFromRow($row, $startcol2);
				if ($key2 !== null) {
					$obj2 = CourseDetailPeer::getInstanceFromPool($key2);
					if (!$obj2) {
				...
				// Add the $obj1 (Course) to the collection in $obj2 (CourseDetail)
				$obj2->addCourse($obj1);
	...
	/**
	 * Selects a collection of Course objects pre-filled with all related objects except CourseDetail.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptCourseDetail(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
