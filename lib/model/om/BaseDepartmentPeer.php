...
abstract class BaseDepartmentPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DepartmentPeer::DESCR);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in InstructorPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Instructor objects
			$c = new Criteria(InstructorPeer::DATABASE_NAME);
			
			$c->add(InstructorPeer::DEPT_ID, $obj->getId());
			$affectedRows += InstructorPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
