...
abstract class BaseDepartment extends BaseObject  implements Persistent {
  ...
  const PEER = 'DepartmentPeer';
	 ...
	 */
	public function getCoursesJoinCourseDetail($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DepartmentPeer::DATABASE_NAME);
		}
		...
		if ($this->collCourses === null) {
			if ($this->isNew()) {
				...
				$this->collCourses = CoursePeer::doSelectJoinCourseDetail($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
