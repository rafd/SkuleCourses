...
abstract class BaseDepartment extends BaseObject  implements Persistent {
  ...
  const PEER = 'DepartmentPeer';
	...
	public function setDescr($v)
	{
		...
		if ($this->descr !== $v) {
			$this->descr = $v;
			$this->modifiedColumns[] = DepartmentPeer::DESCR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = DepartmentPeer::NUM_COLUMNS - DepartmentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DepartmentPeer::DESCR)) $criteria->add(DepartmentPeer::DESCR, $this->descr);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Department has previously been saved, it will retrieve
	 * related Instructors from storage. If this Department is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
