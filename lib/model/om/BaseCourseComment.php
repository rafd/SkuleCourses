...
/**
 * Base class that represents a row from the 'course_coment' table.
 *
 * 
 *
...
abstract class BaseCourseComment extends BaseObject  implements Persistent {
  ...
  const PEER = 'CourseCommentPeer';
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = CourseCommentPeer::USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = CourseCommentPeer::NUM_COLUMNS - CourseCommentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CourseCommentPeer::USER_ID)) $criteria->add(CourseCommentPeer::USER_ID, $this->user_id);
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addCourseComments($this);
			 */
		}
		return $this->aUser;
	}
