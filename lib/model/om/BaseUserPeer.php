...
abstract class BaseUserPeer {
	...
	/** the column name for the REGISTERED_ON field */
	const REGISTERED_ON = 'user.REGISTERED_ON';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserName', 'Password', 'TypeId', 'Email', 'RegisteredOn', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userName', 'password', 'typeId', 'email', 'registeredOn', ),
		BasePeer::TYPE_COLNAME => array (self::USER_NAME, self::PASSWORD, self::TYPE_ID, self::EMAIL, self::REGISTERED_ON, ),
		BasePeer::TYPE_FIELDNAME => array ('user_name', 'password', 'type_id', 'email', 'registered_on', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserName' => 0, 'Password' => 1, 'TypeId' => 2, 'Email' => 3, 'RegisteredOn' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userName' => 0, 'password' => 1, 'typeId' => 2, 'email' => 3, 'registeredOn' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USER_NAME => 0, self::PASSWORD => 1, self::TYPE_ID => 2, self::EMAIL => 3, self::REGISTERED_ON => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('user_name' => 0, 'password' => 1, 'type_id' => 2, 'email' => 3, 'registered_on' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::TYPE_ID);

		$criteria->addSelectColumn(UserPeer::EMAIL);

		$criteria->addSelectColumn(UserPeer::REGISTERED_ON);
	...
	public static function doCountJoinEnumItem(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserPeer::TYPE_ID,), array(EnumItemPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of User objects pre-filled with their EnumItem objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
      ...
      call_user_func($callable, 'BaseUserPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (User) to $obj2 (EnumItem)
				$obj2->addUser($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseUserPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UserPeer::USER_NAME);
			$selectCriteria->add(UserPeer::USER_NAME, $criteria->remove(UserPeer::USER_NAME), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(UserPeer::USER_NAME, (array) $values, Criteria::IN);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(CourseRatingPeer::USER_ID, $obj->getUserName());
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(UserPeer::USER_NAME, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
			$criteria->add(UserPeer::USER_NAME, $pks, Criteria::IN);
