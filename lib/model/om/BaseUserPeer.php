...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserName', 'Password', 'TypeId', 'Email', 'RegisteredOn', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userName', 'password', 'typeId', 'email', 'registeredOn', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_NAME, self::PASSWORD, self::TYPE_ID, self::EMAIL, self::REGISTERED_ON, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_name', 'password', 'type_id', 'email', 'registered_on', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserName' => 1, 'Password' => 2, 'TypeId' => 3, 'Email' => 4, 'RegisteredOn' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userName' => 1, 'password' => 2, 'typeId' => 3, 'email' => 4, 'registeredOn' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_NAME => 1, self::PASSWORD => 2, self::TYPE_ID => 3, self::EMAIL => 4, self::REGISTERED_ON => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_name' => 1, 'password' => 2, 'type_id' => 3, 'email' => 4, 'registered_on' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
