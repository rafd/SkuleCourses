...
abstract class BaseExamCommentPeer {
	...
	const USER_ID = 'exam_comment.USER_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ExamId', 'UserId', 'Comment', 'InputDt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'examId', 'userId', 'comment', 'inputDt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EXAM_ID, self::USER_ID, self::COMMENT, self::INPUT_DT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'exam_id', 'user_id', 'comment', 'input_dt', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ExamId' => 1, 'UserId' => 2, 'Comment' => 3, 'InputDt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'examId' => 1, 'userId' => 2, 'comment' => 3, 'inputDt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EXAM_ID => 1, self::USER_ID => 2, self::COMMENT => 3, self::INPUT_DT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'exam_id' => 1, 'user_id' => 2, 'comment' => 3, 'input_dt' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ExamCommentPeer::USER_ID);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ExamCommentPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of ExamComment objects pre-filled with their User objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of ExamComment objects.
	...
	public static function doSelectJoinUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ExamCommentPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ExamComment) to $obj2 (User)
				$obj2->addExamComment($obj1);
      ...
      call_user_func($callable, 'BaseExamCommentPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (ExamComment) to the collection in $obj3 (User)
				$obj3->addExamComment($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptExam(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of ExamComment objects pre-filled with all related objects except Exam.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptExam(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{

    foreach (sfMixer::getCallables('BaseExamCommentPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseExamCommentPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ExamCommentPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (ExamComment) to the collection in $obj2 (User)
				$obj2->addExamComment($obj1);
	...
	/**
	 * Selects a collection of ExamComment objects pre-filled with all related objects except User.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
