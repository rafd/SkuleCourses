...
abstract class BaseExamCommentPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Comment', 'InputDt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'comment', 'inputDt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::COMMENT, self::INPUT_DT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'comment', 'input_dt', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Comment' => 2, 'InputDt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'comment' => 2, 'inputDt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::COMMENT => 2, self::INPUT_DT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'comment' => 2, 'input_dt' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
