...
abstract class BaseCourse extends BaseObject  implements Persistent {
  ...
  const PEER = 'CoursePeer';
	...
	/**
	 * The value for the detail_id field.
	 * @var        int
	 */
	protected $detail_id;
	...
	/**
	 * Get the [detail_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [detail_id] column.
	 * 
	...
	public function setDetailId($v)
	{
		...
		if ($this->detail_id !== $v) {
			$this->detail_id = $v;
			$this->modifiedColumns[] = CoursePeer::DETAIL_ID;
		}

		if ($this->aCourseDetail !== null && $this->aCourseDetail->getId() !== $v) {
			$this->aCourseDetail = null;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->detail_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->is_eng = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = CoursePeer::NUM_COLUMNS - CoursePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aCourseDetail !== null && $this->detail_id !== $this->aCourseDetail->getId()) {
			$this->aCourseDetail = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aCourseDetail !== null) {
				if ($this->aCourseDetail->isModified() || $this->aCourseDetail->isNew()) {
					$affectedRows += $this->aCourseDetail->save($con);
				}
				$this->setCourseDetail($this->aCourseDetail);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aCourseDetail !== null) {
				if (!$this->aCourseDetail->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aCourseDetail->getValidationFailures());
				}
			}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getDetailId(),
			$keys[4] => $this->getIsEng(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setDetailId($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setIsEng($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CoursePeer::DETAIL_ID)) $criteria->add(CoursePeer::DETAIL_ID, $this->detail_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDetailId($this->detail_id);
	...
	/**
	 * Declares an association between this object and a CourseDetail object.
	 *
	 * @param      CourseDetail $v
	 * @return     Course The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setCourseDetail(CourseDetail $v = null)
	{
		if ($v === null) {
			$this->setDetailId(NULL);
		} else {
			$this->setDetailId($v->getId());
		}

		$this->aCourseDetail = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the CourseDetail object, it will not be re-added.
		if ($v !== null) {
			$v->addCourse($this);
		}
	...
	/**
	 * Get the associated CourseDetail object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     CourseDetail The associated CourseDetail object.
	 * @throws     PropelException
	 */
	public function getCourseDetail(PropelPDO $con = null)
	{
		if ($this->aCourseDetail === null && ($this->detail_id !== null)) {
			$c = new Criteria(CourseDetailPeer::DATABASE_NAME);
			$c->add(CourseDetailPeer::ID, $this->detail_id);
			$this->aCourseDetail = CourseDetailPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCourseDetail->addCourses($this);
			 */
		}
		return $this->aCourseDetail;
	}
	 ...
	 * actually need in Course.
	 */
	public function getCourseInstructorAssociationsJoinEnumItem($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CoursePeer::DATABASE_NAME);
		}
		...
		if ($this->collCourseInstructorAssociations === null) {
			if ($this->isNew()) {
				...
				$this->collCourseInstructorAssociations = CourseInstructorAssociationPeer::doSelectJoinEnumItem($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
