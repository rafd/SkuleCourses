...
abstract class BaseCourseRating extends BaseObject  implements Persistent {
  ...
  const PEER = 'CourseRatingPeer';
	...
	public function setCourseId($v)
	{
		...
		if ($this->course_id !== $v) {
			$this->course_id = $v;
			$this->modifiedColumns[] = CourseRatingPeer::COURSE_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CourseRatingPeer::COURSE_ID)) $criteria->add(CourseRatingPeer::COURSE_ID, $this->course_id);
	...
	public function getCourse(PropelPDO $con = null)
	{
		if ($this->aCourse === null && (($this->course_id !== "" && $this->course_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCourse->addCourseRatings($this);
			 */
		}
		return $this->aCourse;
	}
